        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <AnimatedGridItem key={index} index={index}>
              <Card className="text-center aspect-square md:aspect-auto md:h-full flex flex-col justify-center pt-6 bg-white/5 border border-white/10 backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-white/20 hover:scale-105">
